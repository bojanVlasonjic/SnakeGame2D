...
public class GamePanel extends JPanel {
	...
	protected void paintComponent(Graphics g) {
		...
		// (opposite for 38 is 40, opposite for 37 is 39)
	...
	public void saveHighScore() {
		...
		TopFiveHighScores highScores = TopFiveHighScores.getInstance();
		
		if(highScores.isHighScore(this.score)) {
			// TODO: get user name
			highScores.addNewScore(this.score, this.selectedDifficulty);
		}
		
		try {
			HighScoreIO.writeHighScores((ArrayList<HighScore>) highScores.getHighScores());
